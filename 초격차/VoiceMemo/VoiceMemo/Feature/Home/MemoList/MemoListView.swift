...
struct MemoListView: View {
    ...
    var body: some View {
        ...
        .alert("\(memoListViewModel.removeMemoCount)개 삭제하시겠습니까?",
...
fileprivate struct MemoListContentView: View {
    @EnvironmentObject private var memoListViewModel: MemoListViewModel
...
fileprivate struct MemoCellView: View {
    // 클릭되었을 때 path에 새 뷰 추가하기 때문에 pathModel 필요
    @EnvironmentObject private var pathModel: PathModel
    @EnvironmentObject private var memoListViewModel: MemoListViewModel
                ...
                HStack {
                    ...
                    if memoListViewModel.isEditMemoMode {
                        Button {
                            ...
                            memoListViewModel.memoRemoveSelectedBoxTapped(memo: memo)
                        } label: {
...
fileprivate struct WriteMemoBtnView: View {
    @EnvironmentObject private var pathModel: PathModel
...
struct MemoListView_Previews: PreviewProvider {
  static var previews: some View {
      MemoListView()
          ...
          .environmentObject(MemoListViewModel(memos: [Memo(title: "안녕", content: "", date: Date()),Memo(title: "안녕", content: "", date: Date())]))
  }
}
